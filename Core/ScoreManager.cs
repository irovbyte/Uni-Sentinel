...
internal static class ScoreManager
{
    ...
    private static double t_currentMultiplier = 1.0;
    ...
    public static void AddPoints(int points) =>
        File.WriteAllText(t_scoreFile, (LoadScore() + (int)Math.Ceiling(points * t_currentMultiplier)).ToString(CultureInfo.InvariantCulture));
